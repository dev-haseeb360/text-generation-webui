...
def create_chat_settings_ui():
        ...
        with gr.Row():
            with gr.Column(scale=8):
                with gr.Tab("Character"):
                    ...
                    shared.gradio['name2'] = gr.Textbox(value='')
                    shared.gradio['context'] = gr.Textbox(value='')
                    shared.gradio['greeting'] = gr.Textbox(value='')

                with gr.Tab("User"):
                    shared.gradio['name1'] = gr.Textbox(value=shared.settings['name1'])
                    shared.gradio['user_bio'] = gr.Textbox(value=shared.settings['user_bio'])
    ...
    with gr.Tab('Instruction template'):
        ...
        with gr.Row():
            ...
            with gr.Column():
                shared.gradio['chat_template_str'] = gr.Textbox(value=shared.settings['chat_template_str'])
